\chapter{Thermodynamic modeling of the Pd-Zn-M system for intermetallic catalysts design} \label{chap:intermetallics}
...
\subsection{Site occupancy in the \texorpdfstring{$\gamma$-brass}--phase and surface construction} \label{intermetallics:ssec:PdZnsite}
